...
exports.userprofile.show = function (req, res, next) {
  ...
  var query = UserProfile.find({}).limit(1);
...
exports.userprofile.save = function (req, res, next) {
  ...
  _auxUserProfile.main.mainTitle = (newPost.mainTitle) ? newPost.mainTitle : "";
  _auxUserProfile.main.secondaryTitle = (newPost.secondaryTitle) ? newPost.secondaryTitle : "";


  UserProfile.update({ _id: req.body._id },
      _auxUserProfile,
    { multi : false },
